...
namespace Xeeny
{
    ...
    {
        public static int ReadByte(this byte[] buffer, int index, out byte result)
        {
            result = buffer[index];
            return index + 1;
        }
        public static int ReadInt16(this byte[] buffer, int index, out int result)
        {
        ...
        public static int ReadSubArray(this byte[] buffer, int index, int count, out byte[] result)
        {
            result = GetSubArray(buffer, index, count);
            return index + count;
        }

        public static byte[] GetSubArray(this byte[] buffer, int index, int count)
        {
